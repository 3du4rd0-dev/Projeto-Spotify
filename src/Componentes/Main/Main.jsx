...
const Main = () => {
    ...
    return (
        ...
        // explicação: cada card tem que vim por map consumindo a api artist.json
        // o caminho da api é apiartist from '../../../api-artists/api-artists.json'
        // Crie um componete Card para usar o map
